...
@property (strong, nonatomic) IBOutlet WKWebView *tryWeb;
...
- (void)viewDidLoad {
    ...
    _tryWeb.UIDelegate = self;
    _tryWeb.navigationDelegate = self;
    
    [_tryWeb loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://m.infchain.com/com.inf.mall.inf-mall/d-app/API/infEntry"]]];
}
